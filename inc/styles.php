...
function attoya_hex2rgba($color, $opacity = false) {
...
// Dynamic styles
function attoya_custom_styles($custom) {
  ...
  if ( (get_theme_mod('front_header_type','slider') == 'nothing' && is_front_page()) || (get_theme_mod('site_header_type') == 'nothing' && !is_front_page()) ) {
    ...
    $rgba    = attoya_hex2rgba($menu_bg_color, 0.9);
    $custom .= ".site-header { position:relative;background-color:#000;}" . "\n";
  ...
  // Menu
  $menu_size = get_theme_mod( 'menu_size', '17' );
  if ($menu_size) {
  ...
  if ( $primary_color != '#14a44a' ) {
    ...
    $custom .= ".roll-socials li a:hover,.roll-socials li a,.roll-button.light:hover,.roll-button.border,.roll-button,.roll-icon-list .icon,.roll-icon-box .icon,.owl-theme .owl-controls .owl-page span,.comment .comment-detail,.widget-tags .tag-list a:hover,.blog-pagination ul li,.hentry blockquote,.error-wrap #search-submit:hover,textarea:focus,input[type=\"text\"]:focus,input[type=\"password\"]:focus,input[type=\"datetime\"]:focus,input[type=\"datetime-local\"]:focus,input[type=\"date\"]:focus,input[type=\"month\"]:focus,input[type=\"time\"]:focus,input[type=\"week\"]:focus,input[type=\"number\"]:focus,input[type=\"email\"]:focus,input[type=\"url\"]:focus,input[type=\"search\"]:focus,input[type=\"tel\"]:focus,input[type=\"color\"]:focus, button, input[type=\"button\"], input[type=\"reset\"], input[type=\"submit\"], .archive .team-social li a { color:#ffffff; border-color:" . esc_attr($primary_color) . "; background-color:" . esc_attr($primary_color) . "AA;}"."\n";
  }
  ...
  $custom .= ".overlay { background-color: none; /* " . esc_attr($rows_overlay) . " */}"."\n";
  ...
  wp_add_inline_style( 'attoya-style', $custom );

}
add_action( 'wp_enqueue_scripts', 'attoya_custom_styles' );
